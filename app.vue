        ...
        <nav class="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
            ...
            <div class="flex justify-between "> 
                ...
                <div class=" flex space-x-3 items-center">
                    <img class="p-1 dark:bg-white rounded-full" style='max-width: 75px;' src="https://miro.medium.com/v2/resize:fit:4800/format:webp/1*qJppTMduXXhjgU2tZt9SfQ.png" alt="circle" />                 
                    <!-- <h1 class=" font-normal text-2xl leading-6 text-gray-800 dark:text-white " >Nuxt</h1> -->
                </div>
            ...
            <div class="py-4 px-2">
              <div class="bg-white rounded shadow mt-7 py-7">
                <div class="hidden lg:block md:hidden">
                  <div
                    class="px-7 header flex bg-white lg:justify-around md:justify-around justify-start py-[30px] border-b-[2px] border-slate-100 flex-wrap gap-x-4"
                  >
                    <a class="cursor-pointer">
                      <div class="flex items-center instance group">
                        <div class="svg-container">
                          <svg
                            class="text-[#1E293B] group-hover:text-indigo-700"
                            width="18"
                            height="18"
                            viewBox="0 0 18 18"
                            fill="none"
                    ...
                    <a class="cursor-pointer">
                      <div class="flex items-center group">
                        ...
                        <div class="pl-3 heading-container">
                          <p
                            class="text-base font-medium leading-none text-slate-700 group-hover:text-indigo-700"
                          >
                            Customer
                          </p>
                        </div>
                ...
                <div class="block px-6 lg:hidden md:block">
                  <div class="relative top-1">
                    ...
                    >
                      <button
                        onclick="showDropDownMenutwo_form_layout_wizard3(this)"
                        class="relative flex items-center justify-between w-full px-5 py-4 dropbtn-one"
                      >
                        <span
                          class="pr-4 text-sm font-medium text-indigo-700 flex flex-row-reverse justify-end gap-x-2"
                      ...
                      <div
                        class="absolute right-0 z-20 hidden w-full px-2 py-2 bg-white border-t border-gray-200 rounded shadow top-12"
                        id="drop-down-div-two_form_layout_wizard3"
                      >
                        <div class="flex gap-x-2 group">
                          <p
                            onclick="swaptexttwo_form_layout_wizard3(this)"
                          ...
                          >
                            General
                            <svg
                              class="group-hover:text-indigo-700"
                              onclick="swaptexttwo_form_layout_wizard3(this)"
                              width="18"
                              height="18"
                              viewBox="0 0 18 18"
                        ...
                        <div class="flex gap-x-2 group">
                          <p
                            onclick="swaptexttwo_form_layout_wizard3(this)"
                            class="flex flex-row-reverse justify-end gap-x-2 text-base font-medium leading-none text-gray-600 group-hover:text-indigo-700 mt-[1px] cursor-pointer group-hover:bg-indigo-100 group-hover:font-medium group-hover:text-indigo-700 group-hover:rounded w-full p-3"
                          >
                            Store
                            <svg
                              class="group-hover:text-indigo-700"
                ...
                >
                  ...
                  <button data-modal-target="popup-modal" @click="popup()" data-modal-toggle="popup-modal" class="bg-indigo-700 rounded hover:bg-indigo-600 transform duration-300 ease-in-out text-sm font-medium px-6 py-4 text-white lg:max-w-[80px] w-full" type="button">
                    Save
                  </button>

                  <div id="popup-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                      <div class="relative w-full h-full max-w-md md:h-auto" style="left: 50%;  top: 50%;  transform: translate(-50%, -50%);">
                          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                              ...
                              <div class="p-6 text-center">
                                  ...
                                  <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to save</h3>
                                  <button data-modal-hide="popup-modal" @click="closeModal()" type="button" class="text-white bg-green-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                      Yes, I'm sure
                                  </button>
                                  <button data-modal-hide="popup-modal" type="button" @click="closeModal()" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No, cancel</button>
                              </div>
                          </div>
                      </div>
                  </div>
